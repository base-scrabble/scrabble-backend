class AdminCMS {
    ...
    updateDashboardStats(data) {
        ...
        // Update upcoming tournaments table
                ...
                <form id="editTournamentForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="maxPlayers" value="${tournament.maxPlayers}" min="2" max="128">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="startDate" value="${tournament.startAt ? new Date(tournament.startAt).toISOString().slice(0, 16) : ''}">
                        </div>
                        <div class="form-group">
                            <label>Registration Deadline</label>
                            <input type="datetime-local" name="registrationDeadline" value="${tournament.registrationDeadline ? new Date(tournament.registrationDeadline).toISOString().slice(0, 16) : ''}">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        document.getElementById('editTournamentForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    this.showNotification(result.message || 'Failed to update tournament', 'error');
                }
            } catch (error) {
                this.showNotification('Error updating tournament', 'error');
            }
        });
    }
    ...
    async deleteTournament(tournamentId) {
        ...
        try {
            ...
            if (result.success) {
                ...
                this.showNotification(result.message || 'Failed to delete tournament', 'error');
            }
        } catch (error) {
                ...
                <form id="createScheduleForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="type" onchange="adminCMS.handleScheduleTypeChange(this.value)">
                        ...
                        <div class="form-group" id="frequencyGroup">
                            ...
                            <select name="frequency" onchange="adminCMS.handleFrequencyChange(this.value)">
        ...
        document.getElementById('createScheduleForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    this.showNotification(result.message || 'Failed to create schedule', 'error');
                }
            } catch (error) {
    ...
    handleScheduleTypeChange(type) {
        ...
        frequencyGroup.style.display = type === 'recurring' ? 'block' : 'none';
    }
        ...
        document.getElementById('editScheduleForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    this.showNotification(result.message || 'Failed to update schedule', 'error');
                }
            } catch (error) {
    ...
    async toggleSchedule(scheduleId, currentStatus) {
        try {
            ...
            if (result.success) {
                this.loadSchedules();
                this.showNotification(`Schedule ${currentStatus ? 'disabled' : 'enabled'} successfully`, 'success');
            } else {
                this.showNotification(result.message || 'Failed to toggle schedule', 'error');
            }
        } catch (error) {
    ...
    async deleteSchedule(scheduleId) {
        ...
        try {
            ...
            if (result.success) {
                ...
                this.showNotification(result.message || 'Failed to delete schedule', 'error');
            }
        } catch (error) {
    ...
    async banUser(userId, duration = 24) {
        ...
        try {
            ...
            if (result.success) {
                ...
                this.showNotification(result.message || 'Failed to ban user', 'error');
            }
        } catch (error) {
    ...
    async clearLogs() {
        ...
        try {
            ...
            if (result.success) {
                ...
                this.showNotification(result.message || 'Failed to clear logs', 'error');
            }
        } catch (error) {
    ...
    async generateBracket(tournamentId) {
        try {
            ...
            const result = await response.json();
            if (result.success) {
                this.showAlert('Tournament bracket generated successfully', 'success');
                this.loadTournaments(); // Refresh tournament list
            } else {
                this.showAlert(result.message || 'Failed to generate bracket', 'error');
            }
        } catch (error) {
            console.error('Error generating bracket:', error);
            this.showAlert('Error generating tournament bracket', 'error');
        }
    }
    ...
    showCreateScheduleModal() {
        // Allow creating schedules without tournaments
        // if (!this.tournaments || this.tournaments.length === 0) {
        //     this.showAlert('Please create at least one tournament first to use as a template for scheduling.', 'warning');
        //     return;
        // }
...
function showSection(sectionName) {
    adminCMS.showSection(sectionName);
}
...
function showCreateTournamentModal() {
    adminCMS.showCreateTournamentModal();
}

function closeTournamentModal() {
    adminCMS.closeTournamentModal();
}

function showCreateScheduleModal() {
    adminCMS.showCreateScheduleModal();
}
...
// Initialize the admin CMS when page loads
let adminCMS;
